...
function Game(canvas) {
    ...
    this._boardRender = new BoardRender(this._ctx, this._boardModel);
    this.handleResize();
}
...
_p.handleClick = function (x, y) {
    ...
    if (turn.status != BoardModel.ILLEGAL_TURN) {
        this._boardRender.drawToken(turn.x, turn.y);
    }
...
_p.handleResize = function () {
    ...
    this._boardRender.setSize(this._boardRect.x, this._boardRect.y, this._boardRect.cellSize);
    this._boardRender.repaint();
};
